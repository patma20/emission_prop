...
class N3(pyc.Cycle):
    ...
    def setup(self):
        ...
        if USE_NOXT4:
            self.add_subsystem("NOx", NOxT4())

            # Connect NOx emissions variables
            self.connect("bld3.Fl_O:tot:P", "NOx.P3")
            self.connect("bld3.Fl_O:tot:T", "NOx.T3")
            self.connect("burner.Fl_O:tot:T", "NOx.T4")

        if USE_NOXT3:
            self.add_subsystem("NOx", NOxFit())
            # Connect NOx emissions variables
            self.connect("bld3.Fl_O:tot:P", "NOx.P3")
            self.connect("bld3.Fl_O:tot:T", "NOx.T3")

        if USE_NOXHUM:
            self.add_subsystem("NOx", NOxHum())
            # Connect NOx emissions variables
            self.connect("bld3.Fl_O:tot:P", "NOx.P3")
            self.connect("bld3.Fl_O:tot:T", "NOx.T3")
        ...
        if any([USE_NOXHUM, USE_NOXT3, USE_NOXT4]):
            main_order.append("NOx")
...
class MPN3(pyc.MPCycle):
    ...
    def setup(self):
        ...
        # self.pyc_add_cycle_param("EINOx.H_OD", 0.001)

        initial_order = ["T4_ratio", "TOC", "RTO", "SLS", "CRZ", "humidity", "EINOx"]
...
if __name__ == "__main__":
    ...
    # print("TOC T4", prob["TOC.burner.Fl_O:tot:T"])
    # print("RTO T4", prob["RTO.burner.Fl_O:tot:T"])
    # print("SLS T4", prob["SLS.burner.Fl_O:tot:T"])
    # print("CRZ T4", prob["CRZ.burner.Fl_O:tot:T"])
    # print("TOC T3", prob["TOC.bld3.Fl_O:stat:T"])
    # print("RTO T3", prob["RTO.bld3.Fl_O:stat:T"])
    # print("SLS T3", prob["SLS.bld3.Fl_O:stat:T"])
    # print("CRZ T3", prob["CRZ.bld3.Fl_O:stat:T"])
    # print("TOC P3", prob["TOC.bld3.Fl_O:stat:P"])
    # print("RTO P3", prob["RTO.bld3.Fl_O:stat:P"])
    # print("SLS P3", prob["SLS.bld3.Fl_O:stat:P"])
    # print("CRZ P3", prob["CRZ.bld3.Fl_O:stat:P"])
    # print("EINOx", prob["EINOx.EINOx_OD"])
    # print("EINOx", prob["EINOx.EINOx_SLS"])
    # print("EINOx", prob["EINOx.H"])
    # print("EINOx", prob["EINOx.P3_OD"])
    # print("EINOx", prob["EINOx.P3_SLS"])
