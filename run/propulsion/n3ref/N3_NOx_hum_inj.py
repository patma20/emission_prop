...
class N3(pyc.Cycle):
    ...
    def setup(self):
        ...
        self.pyc_connect_flow("inject.Fl_O", "hpc.Fl_I")
...
class MPN3(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.pyc_add_cycle_param("inject.mix:W", 0.00009, units="lbm/s")
...
if __name__ == "__main__":
    ...
    prob.set_val("TOC.balance.rhs:hpc_PR", 60.0)  # 53.6332
    ...
    # w_inject = np.linspace(0.03, 0.000001, n)
    w_inject = [0.009]
    TSFC_CRZ = np.zeros(n)
    TSFC_TOC = np.zeros(n)
