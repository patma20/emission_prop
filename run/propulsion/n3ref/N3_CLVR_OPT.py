...
def N3_MDP_Opt_model(output_dir, save_res=True):
    ...
    prob.model.add_design_var("TOC.extract.sub_flow.w_frac", lower=0.0001, upper=0.08, ref0=0.0001, ref=0.08)
...
if __name__ == "__main__":
    save_res = True
    output_dir = "../OUTPUT/N3_opt/CLVR/wfrac012"
    ...
    # prob["CRZ.extract.sub_flow.w_frac"] = 0.065
