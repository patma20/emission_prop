...
from components.injector_old import Injector
...
class MPN3(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.set_input_defaults("TOC.inject.mix:W", 0.0, units="lbm/s"),
        ...
        self.w_inject = [0.0000, 0.0000, 0.0000]
...
if __name__ == "__main__":
    ...
    prob.set_val("TOC.balance.rhs:hpc_PR", 60.0)  #
